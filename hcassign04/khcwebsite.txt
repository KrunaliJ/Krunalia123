...
<head>
 ...
 <link href="khc-style.css" rel="stylesheet">
</head>
<body id="section_1">
    ...
    <nav class="navbar navbar-expand-lg bg-light shadow-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link click-scroll" >About</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link click-scroll">Causes</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link click-scroll">Volunteer</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                        <li><a class="dropdown-item">News Listing</a></li>

                        <li><a class="dropdown-item">News Detail</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item ms-3">
                    <a class="nav-link custom-btn custom-border-btn btn">Donate</a>
                </li>
                </ul>
            </div>
        </div>
